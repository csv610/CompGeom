...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="3D Sweep Curve Walk.")
    ...
    print(f"--- 3D Sweep Curve ---")
    print(f"Grid: {width}x{height}x{depth}")

    path_coords = SpaceFillingCurves.sweep_3d(width, height, depth)
