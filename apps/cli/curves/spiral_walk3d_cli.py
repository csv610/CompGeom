...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="3D Spiral Walk generator")
    ...
    parser.add_argument("-sx", "--start_x", type=int, help="Starting X coordinate.")
    parser.add_argument("-sy", "--start_y", type=int, help="Starting Y coordinate.")
    parser.add_argument("-sz", "--start_z", type=int, help="Starting Z coordinate.")
    ...
    print(f"--- 3D Spiral Walk ({width}x{height}x{depth}) ---")

    path_coords = SpaceFillingCurves.spiral_3d(
        width, height, depth, args.start_x, args.start_y, args.start_z
    )
