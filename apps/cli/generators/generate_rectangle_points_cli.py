...
from compgeom.mesh import MeshExporter
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "-H", "--height", type=float, default=1.0, help="Rectangle height."
    )
    parser.add_argument(
        "-n", "--count", type=int, default=100, help="Number of points to generate."
    )
    parser.add_argument(
        "-o",
        "--output",
    ...
    MeshExporter.write(args.output, points, faces=[])
