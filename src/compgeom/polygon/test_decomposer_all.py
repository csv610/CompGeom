...
def test_convex_decomposition():
    # L-shape
    polygon_points = [Point(0, 0), Point(2, 0), Point(2, 1), Point(1, 1), Point(1, 2), Point(0, 2)]
...
def test_monotone_decomposition():
    # U-shape
    polygon_points = [
        Point(0, 0), Point(4, 0), Point(4, 4), Point(3, 4), 
        Point(3, 1), Point(1, 1), Point(1, 4), Point(0, 4)
    ]
