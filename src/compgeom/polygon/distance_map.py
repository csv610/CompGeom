...
class DistanceMapSolver:
    """Calculates distance maps from polygon boundaries using the Eikonal equation."""
    ...
    @staticmethod
    def visualize_svg(grid: List[List[float]], extent: Tuple[float, float, float, float]) -> str:
