...
from compgeom.mesh.volume.tetmesh.utils import get_tet_circumcenter
...
class VoronoiDiagram3D:
    ...
    def compute(self, points: List[Point3D]) -> PolyhedralMesh:
        ...
        from compgeom.mesh.volume.tetmesh.delaunay_mesh_incremental import IncrementalDelaunayMesher3D
