...
from compgeom.mesh.surface.trimesh.delaunay_mesh_incremental import triangulate_incremental_fast
from compgeom.mesh.surface.trimesh.delaunay_dc import triangulate_divide_and_conquer
from compgeom.mesh.surface.trimesh.delaunay_naive import triangulate_naive, Triangle
from compgeom.mesh.surface.trimesh.delaunay_dynamic import DynamicDelaunay, DTriangle
from compgeom.mesh.surface.trimesh.delaunay_constrained import constrained_delaunay_triangulation
from compgeom.mesh.surface.trimesh.delaunay_mesh_edgeflip import triangulate_edgeflip
...
class DelaunayMesher:
    ...
    def merge(mesh1: TriMesh, mesh2: TriMesh, algorithm: str = "edge_flip") -> TriMesh:
        ...
        from compgeom.mesh.surface.trimesh.delaunay_mesh_edgeflip import EdgeFlipDelaunayMesher
