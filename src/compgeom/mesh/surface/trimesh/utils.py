...
if TYPE_CHECKING:
    from compgeom.mesh.surface.trimesh.delaunay_mesh_edgeflip import EdgeFlipTriangle
    from compgeom.mesh.surface.trimesh.delaunay_mesh_incremental import IncrementalTriangle
