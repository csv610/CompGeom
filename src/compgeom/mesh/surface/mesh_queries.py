...
class MeshQueries:
    ...
    def mesh_intersection(mesh_a: SurfaceMesh, mesh_b: SurfaceMesh) -> List[Tuple[int, int]]:
        ...
        def intersect_nodes(node_a, node_b):
            ...
            # AABB overlap check
            if (
                node_a.bmin[0] > node_b.bmax[0]
                or node_b.bmin[0] > node_a.bmax[0]
                or node_a.bmin[1] > node_b.bmax[1]
                or node_b.bmin[1] > node_a.bmax[1]
                or node_a.bmin[2] > node_b.bmax[2]
                or node_b.bmin[2] > node_a.bmax[2]
            ):
                return
