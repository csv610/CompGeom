...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "-x", "--width", type=int, default=32, help="Width of the grid."
    )
    parser.add_argument(
        "-y", "--height", type=int, default=32, help="Height of the grid."
    )
    parser.add_argument(
        "-z", "--depth", type=int, default=32, help="Depth of the grid."
    )
    ...
    order = (
        ...
        else (int(math.log2(min(args.width, args.height, args.depth))) or 1)
    )
